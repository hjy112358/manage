$(function(){
    ...
    $(".changeStatus").on("click", function () {
        var href = '/views/warehouse/otherStockchange.html?fid=' + fid ;
        ...
        var $ = layui.$,
            ...
            {field: 'StockBillEntry_Unit',title: '计量单位',width:80,align:'center',templet:function(d){
                if (d.StockBillEntry_Unit) {
                    var index2 = meaid.indexOf(d.StockBillEntry_Unit)
                    if (index2 == '-1') {
                        return ''
                    } else {
                        return meanick[index2]
                    }
                } else {
                    return ''
                }
        ...
        success: function (res) {
            ...
            if (isussecc) {
                ...
                if(suppernick==''){
                    ...
                    $("#StockBill_Supper").val(suppernick)
                }
            } else {
                getcustom(id)
                alert(res.Message)
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (isussecc) {
                ...
                if(customnick!=''){
                    $("#StockBill_custom").val(datanow.customnick)
                }
            } else {
                alert(res.Message)
            }
