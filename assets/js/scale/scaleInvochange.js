        ...
        tableIns = table.render({
            ...
            cols: [
                [{
                    ...
                    {
                        field: 'SalesInvoiceEntry_Material',
                        title: '物料',
                        templet: function (d) {
                    ...
                    {
                        field: 'SalesInvoiceEntry_Specifications',
                        title: '规格型号'
                    },
                    {
                        field: 'SalesInvoiceEntry_Unit',
                        title: '单位',
                        templet: function (d) {
                    ...
                    {
                        field: 'SalesInvoiceEntry_BatchNo',
                        title: '批号'
                    },
                    {
                        field: 'SalesInvoiceEntry_Quantity',
                        title: '数量'
                    },
                    {
                        field: 'SalesInvoiceEntry_Price',
                        title: '单价'
                    },
                    {
                        field: 'SalesInvoiceEntry_TaxPrice',
                        title: '含税单价',
                        templet: function (d) {
                    ...
                    {
                        field: 'SalesInvoiceEntry_Amount',
                        title: '金额',
                        templet: function (d) {
                    ...
                    {
                        field: 'SalesInvoiceEntry_ExRate',
                        title: '税率(%)'
                    },
                    {
                        field: 'SalesInvoiceEntry_Tax',
                        title: '税额',
                        templet: function (d) {
